...
class Reward(object):
    ...
    def get_reward(self, input_x,  uid_batch, iid_batch, u_batch, i_batch, reuid, reiid,rev_lens_batch):
        rewards = []
        for i in range(self.rollout_num):
            for given_num in range(1, self.model.sequence_length // self.model.step_size):
                ...
                feed = {self.model.x: input_x, self.model.given_num: real_given_num, self.model.input_u:u_batch,self.model.input_i:i_batch,
                        ...
                        self.model.drop_out: 1.0, self.model.dropout_his:1.0, self.model.train:0, self.model.batch_lens:rev_lens_batch}
